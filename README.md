...
### 2. Using cURL
You can hit the API directly from your terminal. *(Note: The ```-i``` flag ensures the response headers, including the conversion time, are printed to your terminal.)*
```
